...
public class ContactServiceImpl implements ContactService {
	...
	public void modifyContact() {
		...
		int contact_no = sc.nextInt();
		ContactDTO contact = dao.selectContactByNo(contact_no);		// 수정하기 전의 내용을 저장한 contact
		
		System.out.print("수정할 항목 선택 (1.이름 2.전화번호 3.이메일 4.주소) >>> ");
		String choice = sc.next();
		switch(choice) {
			case "1" : System.out.print("수정할 이름 입력 >>> ");
					   contact.setName(sc.next()); break;
			case "2" : System.out.print("수정할 전화번호 입력 >>> ");
					   contact.setTel(sc.next()); break;
			case "3" : System.out.print("수정할 이메일 입력 >>> ");
					   contact.setEmail(sc.next()); break;
			case "4" : System.out.print("수정할 주소 입력 >>> ");
			   		   contact.setAddress(sc.next()); break;
			default : System.out.println("잘못된 입력입니다. 수정을 취소합니다."); return;
